...
public class Constants {
    ...
    public static final double MOTION_MAGIC_CRUISE_VELOCITY = 0.05 * TICKS_PER_METER / 10;
    public static final double MOTION_MAGIC_ACCELERATION= 0.05 * TICKS_PER_METER / 10;
