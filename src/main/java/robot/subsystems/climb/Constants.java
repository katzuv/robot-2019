...
public class Constants {
    ...
    static final double[] CLIMB_PIDFE = isRobotA ? new double[]{11.567, 0, 0, 7.895, 0} : new double[]{11.567, 0, 0, 7.895, 0.05}; //Proportional, Intergral, Differential, Feedforward and our own ErrorFix
    ...
    public static final int MOTION_MAGIC_CRUISE_VELOCITY = (int)(0.06 * TICKS_PER_METER / 10);
    public static final int MOTION_MAGIC_ACCELERATION= (int)(0.06 * TICKS_PER_METER / 10);
    ...
    public static final int BACK_RIGHT_STARTING_OFFSET = -170; //if the leg were to move until the limit switch, what would be its value.
    public static final int BACK_LEFT_STARTING_OFFSET = -170; //if the leg were to move until the limit switch, what would be its value.
