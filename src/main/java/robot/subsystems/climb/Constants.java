...
public class Constants {
    ...
    public static final int MOTION_MAGIC_CRUISE_VELOCITY = (int)(0.175 * TICKS_PER_METER / 10); //in meters per seconds
    public static final int MOTION_MAGIC_ACCELERATION= (int)(0.18 * TICKS_PER_METER / 10); //in meters per second squared
    public static final double DRIVE_CLIMB_DRIVETRAIN_DIVISOR = 2;

    public static final int MOTION_MAGIC_CRUISE_VELOCITY_REVERSE = (int)(0.3 * TICKS_PER_METER / 10);
    public static final int MOTION_MAGIC_ACCELERATION_REVERSE = (int)(0.2 * TICKS_PER_METER / 10);
