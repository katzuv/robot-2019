...
public class Constants {
    ...
    public static final double MAX_VELOCITY = 3.262;
    ...
    //VELOCITY CONSTANTS
    public static final double MAX_PATH_VELOCITY = 7.2;
    public static final double MAX_ACCEL = 0.33;
    ...
    public final static double kA = 0.0002;
