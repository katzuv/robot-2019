...
public class VelocityVisionDrive extends Command {
    ...
    public static double[] PIDAngularVelocity = isRobotA ? new double[]{0.3, 0.0001, 0.008} : new double[]{0.3, 0.0001, 0.008};
    public static double[] PIDLinearVelocity = isRobotA ? new double[]{1.6, 0.0001, 0.001} : new double[]{1, 0, 0};
    ...
    protected void execute() {
        ...
        double linearVelocity = Math.min(1.5, linearVelocityPid.getOutput(visionDistance, TARGET_VISION_DISTANCE - EXTRA_PID_DISTANCE));
