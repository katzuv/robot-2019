...
public class SandstormCargo extends CommandGroup {
    ...
    public SandstormCargo() {
        ...
        addSequential(new DrivePathVision(toCargoShip, true, true, 0, 0, false));
        ...
        addSequential(new DrivePathVision(toLoadingStationFront, false, false, 0, 0.8, false));
        ...
        addSequential(new DrivePathVision(toLoadingStation, true, true, 0.8, 0, false));
    }
}
