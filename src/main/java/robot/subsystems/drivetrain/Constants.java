...
public class Constants {
    ...
    public static double[] PIDVisionArcade = isRobotA ? new double[]{0.02, 0, 0} : new double[]{0.02, 0, 0};
    public static double[] PIDVision = isRobotA ? new double[]{0.5, 0, 0} : new double[]{0.5, 0, 0};
