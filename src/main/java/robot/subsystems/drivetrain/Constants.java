...
public class Constants {
    ...
    public static final double[] PIDF = isRobotA ? new double[]{0.9, 0, 10, 1.8} : new double[]{0, 0, 0, 0};
    //    public static final double[] PIDF = isRobotA ? new double[]{3, 0.002, 0.5, 1.8} : new double[]{0, 0, 0, 0};
